        ...
        <div class="modal-dialog">
            ...
            <form action="{{ route('tasks.store') }}" method="POST" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Membungkus elemen dropdown dengan div dan memberikan margin bawah (mb-3) -->
                    <div class="mb-3">

                        <!-- Label untuk dropdown dengan teks "Priority", atribut for menghubungkan label dengan elemen select -->
                        <label for="priority" class="form-label">Priority</label>

                        <!-- Dropdown (select box) untuk memilih prioritas -->
                        <select class="form-control" name="priority" id="priority">

                            <!-- Opsi dengan nilai "low" dan teks "Low" yang akan ditampilkan -->
                            <option value="low">Low</option>

                            <!-- Opsi dengan nilai "medium" dan teks "Medium" yang akan ditampilkan -->
                            <option value="medium">Medium</option>

                            <!-- Opsi dengan nilai "high" dan teks "High" yang akan ditampilkan -->
